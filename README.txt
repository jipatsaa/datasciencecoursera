...
# POST: The result has been saved into the file called "MeanAndStdValuesForEachSubject-Activity.txt\'94)\
################################################################\
\
To execute run: run_analysis.R\
             Two additional files containing R functions are included:\
              1. \'93downloadFromURLAndUnzip.R" \
              2. \'93readTable.R" \
             \
...
\
**********************************************************\
2. Steps pursued to obtain for each subject-activity pair the mean values of the Mean and Standard deviation features from original dataset:\
**********************************************************\
#############################\
...
("https://d396qusza40orc.cloudfront.net/getdata_projectfiles_FUCI HAR Dataset.zip\'94)\
\
